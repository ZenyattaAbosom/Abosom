...
Below are some notes on how to build Abosom Core for Windows.
...
way. This will install to `c:\workspace\abosom`, for example:

    make install DESTDIR=/mnt/c/workspace/abosom
