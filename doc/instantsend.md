...
This mechanism has been integrated into Bitcore-Node-Abosom which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/abosompay/insight-api-abosom#web-socket-api](https://github.com/abosompay/insight-api-abosom#web-socket-api)
* API: [https://github.com/abosompay/insight-api-abosom#instantsend-transactions](https://github.com/abosompay/insight-api-abosom#instantsend-transactions)
...
By default, the Abosom Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Abosom Core daemon:
