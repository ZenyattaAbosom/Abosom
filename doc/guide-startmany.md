...
### Send 1000 ABOSOM to New Addresses

Send exactly 1000 ABOSOM to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 ABOSOM.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 ABOSOM on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the abosom github repo](https://github.com/abosompay/abosom/blob/master/doc/masternode_conf.md)
...
## Update abosom.conf on server

If you generated a new masternode private key, you will need to update the remote `abosom.conf` files.

Shut down the daemon and then edit the file.

```nano .abosomcore/abosom.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `abosom.conf` file.
...
and comparing with the official explorer at https://explorer.abosompay.org/chain/Abosom
...
```
abosom-cli masternode status
{
    "outpoint" : "<collateral_output>-<collateral_output_index>",
    "service" : "<ipaddress>:<port>",
    "pubkey" : "<1000 ABOSOM address>",
...
Search your Masternodes on https://abosomninja.pl/masternodes.html
