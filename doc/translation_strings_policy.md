...
This document provides guidelines for internationalization of the Abosom Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `abosom_en.ts` remains unchanged.
