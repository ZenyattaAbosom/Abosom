...
<context>
    ...
    <message>
        ...
        <translation>每笔输入可能会有 +/- %1个abotoshis(s)的偏差.</translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>(无标签)</translation>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;h3&gt;匿名发送基础知识&lt;/h3&gt;匿名发送通过隐藏您的资金来源为您提供真正的财务隐私。您的钱包中所有的博力币都由不同的“输入”组成，您可以将其视为分开的离散硬币。&lt;br&gt;匿名发送使用创新的方法将您的输入与其他两个人的输入相结合，而过程中不会让您的博力币离开您的钱包。每时每刻，您仍然控制着您的钱。&lt;hr&gt;&lt;b&gt;匿名发送的运作原理如下：&lt;/b&gt;&lt;ol type="1"&gt;&lt;li&gt;匿名发送首先将您的交易分柝成多个标准面额的交易。这些标准面额分别为0.01 ABOSOM，0.1 ABOSOM，1 ABOSOM和10 ABOSOM --有点像您每天使用的纸币。&lt;/li&gt;&lt;li&gt;您的钱包然后发送请求到网络上有专门配置的软件节点，称为“主节点”。这些主节点会收到您希望混合一些资金的通知。没有可识别的信息发送到主节点，所以他们永远不会知道你是“谁”。&lt;li&gt;当另外两个人发送类似的消息时，表示希望混合相同的面额的话，混合会话就会开始。相关的主节点会混合这些输入，并指示所有三个用户的钱包将已经转换了输入的交易支付给自己。您的钱包直接支付给自己，但是付给不同的位址（称之为找零地址）。&lt;/li&gt;&lt;li&gt;为了完全掩盖您的资金来源，您的钱包必须以每个面额来重复此过程数次。每次这个过程完成后，都称之为一个“循环”。每个循环的匿名发送都会令确定您的资金来源的工作倍加困难。&lt;/li&gt;&lt;li&gt;这种混合过程发生在后台，而不需要您进行任何操作。当您想进行交易时，您的资金将已被匿名处理。不需再花额外的时间等待。&lt;/li&gt;&lt;/ol&gt;&lt;hr&gt;重要：&lt;b&gt;您的钱包只能拥有1000个“找零地址”。每次混合事件发生时，最多会使用9个找零地址。这意味着这1000个地址可以容许100次的混合事件。当其的中900个已经被使用后，您的钱包必须创建更多的地址。如果您启用了自动备份，则只能够这样做。&lt;br&gt;因此，禁用备份的用户也将禁用匿名发送。&lt;hr&gt;如欲了解更多信息请参阅&lt;a href="https://abosompay.atlassian.net/wiki/display/DOC/PrivateSend"&gt;https://abosompay.atlassian.net/wiki/display/DOC/PrivateSend&lt;/a&gt;</translation>
    </message>
</context>
<context>
    <name>Intro</name>
...
<context>
    ...
    <message>
        ...
        <translation>如果自定手续费设定为1000 abotoshiss，而交易信息只有250字节的话，那么选择"每千字节"就只会支付250 abotoshiss的手续费，&lt;br /&gt;而"至少"会支付1000 abotoshiss。但如果交易信息大于一千字节,那么两者都要按每千字节付费。</translation>
    </message>
    <message>
        ...
        <translation>如果自定手续费设定为1000 abotoshiss，而交易信息只有250字节的话，那么选择“每千字节”就只会支付250 abotoshiss的手续费，&lt;br /&gt;而"总共至少"会支付1000 abotoshiss。但如果交易信息大于一千字节，那么两者都要按每千字节付费。</translation>
    </message>
    <message>
