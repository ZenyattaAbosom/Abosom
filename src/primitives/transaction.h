...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units abotoshiss-per-kilobyte.
        ...
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 abotoshiss.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in abotoshiss)
        // i.e. 182 * 3 = 546 abotoshiss with default -minrelaytxfee = minRelayTxFee = 1000 abotoshiss per kB.
