...
//! Discourage users to set fees higher than this amount (in abotoshiss) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in abotoshiss)
...
const int fFullComplianceHeight = 450;
...
/** Absolute maximum transaction fee (in abotoshiss) used by wallet and mempool (rejects high fee in sendrawtransaction) */
...
/** Returns whether full DIP3 mode is enabled or not */
