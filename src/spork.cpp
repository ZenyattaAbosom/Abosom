...
const std::string CSporkManager::SERIALIZATION_VERSION_STRING = "Pista Anarchica - GLS";

std::map<int, int64_t> mapSporkDefaults = {
    {SPORK_2_INSTANTSEND_ENABLED,            0},             // ON
    {SPORK_3_INSTANTSEND_BLOCK_FILTERING,    0},             // ON
    {SPORK_5_INSTANTSEND_MAX_VALUE,          100000},        // 100000 Abosom
    {SPORK_6_NEW_SIGS,                       4070908800ULL}, // OFF
    {SPORK_9_SUPERBLOCKS_ENABLED,            1581724800},    // OFF
    {SPORK_12_RECONSIDER_BLOCKS,             0},             // 0 BLOCKS
    {SPORK_15_DETERMINISTIC_MNS_ENABLED,     4070908800ULL}, // OFF
    {SPORK_16_INSTANTSEND_AUTOLOCKS,         1581724800},    // OFF
    {SPORK_17_QUORUM_DKG_ENABLED,            1581724800},    // OFF
    {SPORK_19_CHAINLOCKS_ENABLED,            1581724800},    // OFF
    {SPORK_20_INSTANTSEND_LLMQ_BASED,        1581724800},    // OFF
};
...
{
    if(fLiteMode) return; // disable all Abosom specific functionality
