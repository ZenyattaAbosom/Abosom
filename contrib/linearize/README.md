# Linearize
Construct a linear, no-fork, best version of the Abosom blockchain. The scripts
...
JSON-RPC server. Running `abosomd` or `abosom-qt -server` will be sufficient.
...
* `input`: abosomd blocks/ directory containing blkNNNNN.dat
